...
namespace DynamicCombat
{
    public class DynamicCombatSettings : AttributeGlobalSettings<DynamicCombatSettings>
    {
        ...
        [SettingPropertyFloatingInteger("Min Engagement Distance", 0.5f, 5.0f, "0.00", Order = 2, RequireRestart = false, HintText = "Inner boundary threshold. Enemies will step back if the target gets closer than this.")]
        [SettingPropertyGroup("Engagement Settings")]
        ...
        [SettingPropertyInteger("Rear Blind-Spot Angle", 30, 180, "0", Order = 4, RequireRestart = false, HintText = "The total angle (in degrees) behind a target where enemies are forced into containment hold.")]
        [SettingPropertyGroup("Engagement Settings")]
